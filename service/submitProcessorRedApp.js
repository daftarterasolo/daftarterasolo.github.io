...
export class sidangWilayahSubmitProcessorRedApp extends submitProcessor {
	#obj;
	#api;
	#authData;
	#apiPendataan;
	...
	constructor(obj) {
		...
		//this.apiInsertNonPendataan = "https://script.google.com/macros/s/AKfycbzA9GHqKeUnwFKFNMWPQGAYD5tLr3LEKRNsz1cECy-j-Q-czPtHzhtg1wSfBnhrtakW/exec";
		this.#authData = {
			'id' : sessionStorage.getItem('id'),
			//'token' : sessionStorage.getItem('key')
		};
	...
	set set_apiPendataan(url) {
		this.#apiPendataan = url;
	}
}



export class sidangWilayahQrcodeSubmitProcessorRedApp extends submitProcessor {
	#obj;
	#api;
	#authData;
	#apiPendataan;
	...
	async #entryTheData() {
		...
		*/
		...
		try {
			...
			await fetch("https://script.google.com/macros/s/AKfycby8tahNaMlUxquo8UFcO7E4p2Xiz8082EKC27W7nIHsZ0NryLx9am3RLPfAKsIx55XUDA/exec", {
				method : "POST",
				body : JSON.stringify(dataComplete)
			})
			.then(e => e.json())
